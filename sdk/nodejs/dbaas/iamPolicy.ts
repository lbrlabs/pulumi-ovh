 ...
 * const myGroup = new ovh.dbaas.MeIdentityGroup("myGroup", {description: "my_group created in Terraform"});
 * const manager = new ovh.dbaas.IamPolicy("manager", {
...
export class IamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ovh:Dbaas/iamPolicy:IamPolicy';
