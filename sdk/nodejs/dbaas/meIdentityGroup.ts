 ...
 *
 * const myGroup = new ovh.dbaas.MeIdentityGroup("myGroup", {
...
export class MeIdentityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ovh:Dbaas/meIdentityGroup:MeIdentityGroup';
    ...
    constructor(name: string, argsOrState?: MeIdentityGroupArgs | MeIdentityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MeIdentityGroup.__pulumiType, name, resourceInputs, opts);
    }
}
