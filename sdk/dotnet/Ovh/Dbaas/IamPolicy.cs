...
namespace Lbrlabs.PulumiPackage.Ovh.Dbaas
{
    ...
    ///     });
    /// 
    ///     var manager = new Ovh.Dbaas.IamPolicy("manager", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [OvhResourceType("ovh:Dbaas/iamPolicy:IamPolicy")]
    public partial class IamPolicy : global::Pulumi.CustomResource
    {
        ...
        public IamPolicy(string name, IamPolicyArgs args, CustomResourceOptions? options = null)
            : base("ovh:Dbaas/iamPolicy:IamPolicy", name, args ?? new IamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IamPolicy(string name, Input<string> id, IamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("ovh:Dbaas/iamPolicy:IamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
