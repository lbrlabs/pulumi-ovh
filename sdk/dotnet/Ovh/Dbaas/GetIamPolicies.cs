...
namespace Lbrlabs.PulumiPackage.Ovh.Dbaas
{
    public static class GetIamPolicies
    {
        ...
        /// {
        ///     var myPolicies = Ovh.Dbaas.GetIamPolicies.Invoke();
        /// 
        /// });
        /// ```
        /// {{% /example %}}
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetIamPoliciesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIamPoliciesResult>("ovh:Dbaas/getIamPolicies:getIamPolicies", InvokeArgs.Empty, options.WithDefaults());
    }
