...
import com.pulumi.ovh.inputs.CloudProjectNetworkPrivateRegionsAttributeArgs;
import com.pulumi.ovh.inputs.CloudProjectNetworkPrivateRegionsStatusArgs;
...
public final class CloudProjectNetworkPrivateState extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectNetworkPrivateState Empty = new CloudProjectNetworkPrivateState();
    ...
    private @Nullable Output<List<CloudProjectNetworkPrivateRegionsAttributeArgs>> regionsAttributes;
     ...
     * 
     */
    public Optional<Output<List<CloudProjectNetworkPrivateRegionsAttributeArgs>>> regionsAttributes() {
    ...
    private @Nullable Output<List<CloudProjectNetworkPrivateRegionsStatusArgs>> regionsStatuses;
     ...
     */
    @Deprecated /* use the regions_attributes field instead */
    public Optional<Output<List<CloudProjectNetworkPrivateRegionsStatusArgs>>> regionsStatuses() {
    ...
    private CloudProjectNetworkPrivateState() {}

    private CloudProjectNetworkPrivateState(CloudProjectNetworkPrivateState $) {
        this.name = $.name;
    ...
    public static Builder builder(CloudProjectNetworkPrivateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectNetworkPrivateState();
        }

        public Builder(CloudProjectNetworkPrivateState defaults) {
            $ = new CloudProjectNetworkPrivateState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param regions an array of valid OVH public cloud region ID in which the network
         * will be available. Ex.: &#34;GRA1&#34;. Defaults to all public cloud regions.
         * 
         * @return builder
         * 
         ...
         * 
         */
        public Builder regionsAttributes(@Nullable Output<List<CloudProjectNetworkPrivateRegionsAttributeArgs>> regionsAttributes) {
         ...
         * 
         */
        public Builder regionsAttributes(List<CloudProjectNetworkPrivateRegionsAttributeArgs> regionsAttributes) {
         ...
         * 
         */
        public Builder regionsAttributes(CloudProjectNetworkPrivateRegionsAttributeArgs... regionsAttributes) {
         ...
         */
        @Deprecated /* use the regions_attributes field instead */
        public Builder regionsStatuses(@Nullable Output<List<CloudProjectNetworkPrivateRegionsStatusArgs>> regionsStatuses) {
         ...
         */
        @Deprecated /* use the regions_attributes field instead */
        public Builder regionsStatuses(List<CloudProjectNetworkPrivateRegionsStatusArgs> regionsStatuses) {
         ...
         */
        @Deprecated /* use the regions_attributes field instead */
        public Builder regionsStatuses(CloudProjectNetworkPrivateRegionsStatusArgs... regionsStatuses) {
        ...
        public CloudProjectNetworkPrivateState build() {
            return $;
        }
    }
