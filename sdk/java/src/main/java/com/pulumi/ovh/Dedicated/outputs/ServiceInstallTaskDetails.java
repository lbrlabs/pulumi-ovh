...
@CustomType
public final class ServiceInstallTaskDetails {
    /**
    ...
    private ServiceInstallTaskDetails() {}
    /**
     * @return Template change log details.
     * 
     * @deprecated
    ...
    public static Builder builder(ServiceInstallTaskDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSpla;
        public Builder() {}
        public Builder(ServiceInstallTaskDetails defaults) {
        ...
        public ServiceInstallTaskDetails build() {
            final var o = new ServiceInstallTaskDetails();
