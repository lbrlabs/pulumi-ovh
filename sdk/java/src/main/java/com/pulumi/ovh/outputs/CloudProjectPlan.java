...
import com.pulumi.ovh.outputs.CloudProjectPlanConfiguration;
...
@CustomType
public final class CloudProjectPlan {
    /**
     * @return Catalog name
     * 
     */
     ...
     * 
     */
    private @Nullable List<CloudProjectPlanConfiguration> configurations;
    /**
     * @return duration
     * 
     */
     ...
     * 
     */
    public List<CloudProjectPlanConfiguration> configurations() {
    ...
    public static Builder builder(CloudProjectPlan defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingMode;
        public Builder() {}
        public Builder(CloudProjectPlan defaults) {
        ...
        @CustomType.Setter
        public Builder configurations(@Nullable List<CloudProjectPlanConfiguration> configurations) {
            this.configurations = configurations;
            return this;
        }
        public Builder configurations(CloudProjectPlanConfiguration... configurations) {
        ...
        public CloudProjectPlan build() {
            final var o = new CloudProjectPlan();
