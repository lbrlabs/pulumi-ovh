...
public final class CloudProjectContainerRegistryPlanRegistryLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectContainerRegistryPlanRegistryLimitArgs Empty = new CloudProjectContainerRegistryPlanRegistryLimitArgs();
    ...
    private CloudProjectContainerRegistryPlanRegistryLimitArgs() {}

    private CloudProjectContainerRegistryPlanRegistryLimitArgs(CloudProjectContainerRegistryPlanRegistryLimitArgs $) {
    ...
    public static Builder builder(CloudProjectContainerRegistryPlanRegistryLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectContainerRegistryPlanRegistryLimitArgs();
        }

        public Builder(CloudProjectContainerRegistryPlanRegistryLimitArgs defaults) {
            $ = new CloudProjectContainerRegistryPlanRegistryLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudProjectContainerRegistryPlanRegistryLimitArgs build() {
            return $;
        }
    }
