...
public final class CloudProjectKubeNodePoolState extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectKubeNodePoolState Empty = new CloudProjectKubeNodePoolState();
    ...
    private @Nullable Output<CloudProjectKubeNodePoolTemplateArgs> template;

    /**
     * @return Node pool template
     * 
     */
    public Optional<Output<CloudProjectKubeNodePoolTemplateArgs>> template() {
    ...
    private CloudProjectKubeNodePoolState() {}

    private CloudProjectKubeNodePoolState(CloudProjectKubeNodePoolState $) {
    ...
    public static Builder builder(CloudProjectKubeNodePoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectKubeNodePoolState();
        }

        public Builder(CloudProjectKubeNodePoolState defaults) {
            $ = new CloudProjectKubeNodePoolState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param flavorName a valid OVH public cloud flavor ID in which the nodes will be started.
         * Ex: &#34;b2-7&#34;. Changing this value recreates the resource.
         * You can find the list of flavor IDs: https://www.ovhcloud.com/fr/public-cloud/prices/
         * 
         * @return builder
         ...
         * 
         */
        public Builder template(@Nullable Output<CloudProjectKubeNodePoolTemplateArgs> template) {
            $.template = template;
            return this;
        }
         ...
         * 
         */
        public Builder template(CloudProjectKubeNodePoolTemplateArgs template) {
            return template(Output.of(template));
        }

        /**
         * @param upToDateNodes Number of nodes with latest version installed in the pool
         * 
         * @return builder
         * 
         */
        ...
        public CloudProjectKubeNodePoolState build() {
            return $;
        }
    }
