...
import com.pulumi.ovh.inputs.IpLoadBalancingPlanConfigurationArgs;
...
public final class IpLoadBalancingPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpLoadBalancingPlanArgs Empty = new IpLoadBalancingPlanArgs();
    ...
    private @Nullable Output<List<IpLoadBalancingPlanConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<IpLoadBalancingPlanConfigurationArgs>>> configurations() {
    ...
    private IpLoadBalancingPlanArgs() {}

    private IpLoadBalancingPlanArgs(IpLoadBalancingPlanArgs $) {
    ...
    public static Builder builder(IpLoadBalancingPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpLoadBalancingPlanArgs();
        }

        public Builder(IpLoadBalancingPlanArgs defaults) {
            $ = new IpLoadBalancingPlanArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<IpLoadBalancingPlanConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<IpLoadBalancingPlanConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(IpLoadBalancingPlanConfigurationArgs... configurations) {
        ...
        public IpLoadBalancingPlanArgs build() {
