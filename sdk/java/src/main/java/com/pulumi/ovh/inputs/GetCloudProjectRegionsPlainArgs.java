...
public final class GetCloudProjectRegionsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudProjectRegionsPlainArgs Empty = new GetCloudProjectRegionsPlainArgs();
    ...
    private GetCloudProjectRegionsPlainArgs() {}

    private GetCloudProjectRegionsPlainArgs(GetCloudProjectRegionsPlainArgs $) {
    ...
    public static Builder builder(GetCloudProjectRegionsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudProjectRegionsPlainArgs();
        }

        public Builder(GetCloudProjectRegionsPlainArgs defaults) {
            $ = new GetCloudProjectRegionsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudProjectRegionsPlainArgs build() {
