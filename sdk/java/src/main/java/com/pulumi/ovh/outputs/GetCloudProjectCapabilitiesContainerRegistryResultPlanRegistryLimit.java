...
@CustomType
public final class GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit {
    /**
    ...
    private GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit() {}
    /**
     * @return Docker image storage limits in bytes
     * 
     */
    ...
    public static Builder builder(GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit defaults) {
    ...
    public static final class Builder {
        ...
        private Integer parallelRequest;
        public Builder() {}
        public Builder(GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit defaults) {
        ...
        public GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit build() {
            final var o = new GetCloudProjectCapabilitiesContainerRegistryResultPlanRegistryLimit();
