...
import com.pulumi.ovh.outputs.DomainZonePlanConfiguration;
...
@CustomType
public final class DomainZonePlan {
    /**
     * @return Catalog name
     * 
     */
     ...
     * 
     */
    private @Nullable List<DomainZonePlanConfiguration> configurations;
    /**
     * @return duration
     * 
     */
     ...
     * 
     */
    public List<DomainZonePlanConfiguration> configurations() {
    ...
    public static Builder builder(DomainZonePlan defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingMode;
        public Builder() {}
        public Builder(DomainZonePlan defaults) {
        ...
        @CustomType.Setter
        public Builder configurations(@Nullable List<DomainZonePlanConfiguration> configurations) {
            this.configurations = configurations;
            return this;
        }
        public Builder configurations(DomainZonePlanConfiguration... configurations) {
        ...
        public DomainZonePlan build() {
            final var o = new DomainZonePlan();
