...
import com.pulumi.ovh.inputs.IpLoadBalancingPlanOptionConfigurationArgs;
...
public final class IpLoadBalancingPlanOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpLoadBalancingPlanOptionArgs Empty = new IpLoadBalancingPlanOptionArgs();
    ...
    private @Nullable Output<List<IpLoadBalancingPlanOptionConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<IpLoadBalancingPlanOptionConfigurationArgs>>> configurations() {
    ...
    private IpLoadBalancingPlanOptionArgs() {}

    private IpLoadBalancingPlanOptionArgs(IpLoadBalancingPlanOptionArgs $) {
    ...
    public static Builder builder(IpLoadBalancingPlanOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpLoadBalancingPlanOptionArgs();
        }

        public Builder(IpLoadBalancingPlanOptionArgs defaults) {
            $ = new IpLoadBalancingPlanOptionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<IpLoadBalancingPlanOptionConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<IpLoadBalancingPlanOptionConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(IpLoadBalancingPlanOptionConfigurationArgs... configurations) {
        ...
        public IpLoadBalancingPlanOptionArgs build() {
