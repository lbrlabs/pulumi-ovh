...
import com.pulumi.ovh.inputs.CloudProjectPlanOptionConfigurationArgs;
...
public final class CloudProjectPlanOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectPlanOptionArgs Empty = new CloudProjectPlanOptionArgs();
    ...
    private @Nullable Output<List<CloudProjectPlanOptionConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<CloudProjectPlanOptionConfigurationArgs>>> configurations() {
    ...
    private CloudProjectPlanOptionArgs() {}

    private CloudProjectPlanOptionArgs(CloudProjectPlanOptionArgs $) {
    ...
    public static Builder builder(CloudProjectPlanOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectPlanOptionArgs();
        }

        public Builder(CloudProjectPlanOptionArgs defaults) {
            $ = new CloudProjectPlanOptionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<CloudProjectPlanOptionConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<CloudProjectPlanOptionConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(CloudProjectPlanOptionConfigurationArgs... configurations) {
        ...
        public CloudProjectPlanOptionArgs build() {
