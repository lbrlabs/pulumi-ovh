...
import com.pulumi.ovh.inputs.CloudProjectPlanConfigurationArgs;
...
public final class CloudProjectPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectPlanArgs Empty = new CloudProjectPlanArgs();
    ...
    private @Nullable Output<List<CloudProjectPlanConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<CloudProjectPlanConfigurationArgs>>> configurations() {
    ...
    private CloudProjectPlanArgs() {}

    private CloudProjectPlanArgs(CloudProjectPlanArgs $) {
    ...
    public static Builder builder(CloudProjectPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectPlanArgs();
        }

        public Builder(CloudProjectPlanArgs defaults) {
            $ = new CloudProjectPlanArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<CloudProjectPlanConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<CloudProjectPlanConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(CloudProjectPlanConfigurationArgs... configurations) {
        ...
        public CloudProjectPlanArgs build() {
