...
@CustomType
public final class CloudProjectUserRole {
    /**
    ...
    public static Builder builder(CloudProjectUserRole defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> permissions;
        public Builder() {}
        public Builder(CloudProjectUserRole defaults) {
        ...
        public CloudProjectUserRole build() {
            final var o = new CloudProjectUserRole();
