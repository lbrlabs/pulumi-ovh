...
import com.pulumi.ovh.inputs.DomainZonePlanConfigurationArgs;
...
public final class DomainZonePlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainZonePlanArgs Empty = new DomainZonePlanArgs();
    ...
    private @Nullable Output<List<DomainZonePlanConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<DomainZonePlanConfigurationArgs>>> configurations() {
    ...
    private DomainZonePlanArgs() {}

    private DomainZonePlanArgs(DomainZonePlanArgs $) {
    ...
    public static Builder builder(DomainZonePlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainZonePlanArgs();
        }

        public Builder(DomainZonePlanArgs defaults) {
            $ = new DomainZonePlanArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<DomainZonePlanConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<DomainZonePlanConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(DomainZonePlanConfigurationArgs... configurations) {
        ...
        public DomainZonePlanArgs build() {
