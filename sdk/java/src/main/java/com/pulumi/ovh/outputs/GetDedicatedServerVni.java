...
@CustomType
public final class GetDedicatedServerVni {
    /**
    ...
    public static Builder builder(GetDedicatedServerVni defaults) {
    ...
    public static final class Builder {
        ...
        private String vrack;
        public Builder() {}
        public Builder(GetDedicatedServerVni defaults) {
        ...
        public GetDedicatedServerVni build() {
            final var o = new GetDedicatedServerVni();
            o.enabled = enabled;
            o.mode = mode;
            o.name = name;
            o.nics = nics;
