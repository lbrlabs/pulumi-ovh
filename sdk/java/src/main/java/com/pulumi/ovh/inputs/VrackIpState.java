...
public final class VrackIpState extends com.pulumi.resources.ResourceArgs {

    public static final VrackIpState Empty = new VrackIpState();
    ...
    private VrackIpState() {}

    private VrackIpState(VrackIpState $) {
        this.block = $.block;
    ...
    public static Builder builder(VrackIpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VrackIpState defaults) {
            $ = new VrackIpState(Objects.requireNonNull(defaults));
        }
