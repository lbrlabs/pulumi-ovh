...
import com.pulumi.ovh.outputs.GetOrderCartProductPlanPricePrice;
...
@CustomType
public final class GetOrderCartProductPlanPrice {
    /**
     ...
     * 
     */
    private List<GetOrderCartProductPlanPricePrice> prices;
    /**
    ...
    private GetOrderCartProductPlanPrice() {}
    /**
     * @return Capacities of the pricing (type of pricing)
     * 
     */
     ...
     * 
     */
    public List<GetOrderCartProductPlanPricePrice> prices() {
        return this.prices;
    }
    /**
     * @return Pricing model identifier
    ...
    public static Builder builder(GetOrderCartProductPlanPrice defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingType;
        public Builder() {}
        public Builder(GetOrderCartProductPlanPrice defaults) {
        ...
        @CustomType.Setter
        public Builder prices(List<GetOrderCartProductPlanPricePrice> prices) {
            this.prices = Objects.requireNonNull(prices);
            return this;
        }
        public Builder prices(GetOrderCartProductPlanPricePrice... prices) {
        ...
        public GetOrderCartProductPlanPrice build() {
            final var o = new GetOrderCartProductPlanPrice();
