...
public final class DedicatedServerUpdateArgs extends com.pulumi.resources.ResourceArgs {

    public static final DedicatedServerUpdateArgs Empty = new DedicatedServerUpdateArgs();
    ...
    private DedicatedServerUpdateArgs() {}

    private DedicatedServerUpdateArgs(DedicatedServerUpdateArgs $) {
        this.bootId = $.bootId;
    ...
    public static Builder builder(DedicatedServerUpdateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DedicatedServerUpdateArgs();
        }

        public Builder(DedicatedServerUpdateArgs defaults) {
            $ = new DedicatedServerUpdateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DedicatedServerUpdateArgs build() {
