...
@CustomType
public final class GetCloudProjectCapabilitiesContainerFilterRegistryLimit {
    /**
    ...
    private GetCloudProjectCapabilitiesContainerFilterRegistryLimit() {}
    /**
     * @return Docker image storage limits in bytes
     * 
     */
    ...
    public static Builder builder(GetCloudProjectCapabilitiesContainerFilterRegistryLimit defaults) {
    ...
    public static final class Builder {
        ...
        private Integer parallelRequest;
        public Builder() {}
        public Builder(GetCloudProjectCapabilitiesContainerFilterRegistryLimit defaults) {
        ...
        public GetCloudProjectCapabilitiesContainerFilterRegistryLimit build() {
            final var o = new GetCloudProjectCapabilitiesContainerFilterRegistryLimit();
