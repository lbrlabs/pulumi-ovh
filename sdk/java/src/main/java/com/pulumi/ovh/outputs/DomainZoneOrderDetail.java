...
@CustomType
public final class DomainZoneOrderDetail {
    /**
     * @return description
     * 
     */
    ...
    public static Builder builder(DomainZoneOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(DomainZoneOrderDetail defaults) {
        ...
        public DomainZoneOrderDetail build() {
            final var o = new DomainZoneOrderDetail();
