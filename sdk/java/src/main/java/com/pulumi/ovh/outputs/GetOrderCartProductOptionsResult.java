...
import com.pulumi.ovh.outputs.GetOrderCartProductOptionsResultPrice;
...
@CustomType
public final class GetOrderCartProductOptionsResult {
    /**
     ...
     * 
     */
    private List<GetOrderCartProductOptionsResultPrice> prices;
    /**
     ...
     * 
     */
    public List<GetOrderCartProductOptionsResultPrice> prices() {
        return this.prices;
    }
    /**
     * @return Name of the product
    ...
    public static Builder builder(GetOrderCartProductOptionsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String productType;
        public Builder() {}
        public Builder(GetOrderCartProductOptionsResult defaults) {
        ...
        @CustomType.Setter
        public Builder prices(List<GetOrderCartProductOptionsResultPrice> prices) {
            this.prices = Objects.requireNonNull(prices);
            return this;
        }
        public Builder prices(GetOrderCartProductOptionsResultPrice... prices) {
        ...
        public GetOrderCartProductOptionsResult build() {
            final var o = new GetOrderCartProductOptionsResult();
