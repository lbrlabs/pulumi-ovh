...
@CustomType
public final class GetMePaymentmeanBankAccountResult {
    /**
    ...
    public static Builder builder(GetMePaymentmeanBankAccountResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useOldest;
        public Builder() {}
        public Builder(GetMePaymentmeanBankAccountResult defaults) {
        ...
        public GetMePaymentmeanBankAccountResult build() {
            final var o = new GetMePaymentmeanBankAccountResult();
            o.default_ = default_;
