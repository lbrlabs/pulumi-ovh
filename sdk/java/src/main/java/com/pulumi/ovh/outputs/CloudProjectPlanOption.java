...
import com.pulumi.ovh.outputs.CloudProjectPlanOptionConfiguration;
...
@CustomType
public final class CloudProjectPlanOption {
    /**
     * @return Catalog name
     * 
     */
     ...
     * 
     */
    private @Nullable List<CloudProjectPlanOptionConfiguration> configurations;
    /**
     * @return duration
     * 
     */
     ...
     * 
     */
    public List<CloudProjectPlanOptionConfiguration> configurations() {
    ...
    public static Builder builder(CloudProjectPlanOption defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingMode;
        public Builder() {}
        public Builder(CloudProjectPlanOption defaults) {
        ...
        @CustomType.Setter
        public Builder configurations(@Nullable List<CloudProjectPlanOptionConfiguration> configurations) {
            this.configurations = configurations;
            return this;
        }
        public Builder configurations(CloudProjectPlanOptionConfiguration... configurations) {
        ...
        public CloudProjectPlanOption build() {
            final var o = new CloudProjectPlanOption();
