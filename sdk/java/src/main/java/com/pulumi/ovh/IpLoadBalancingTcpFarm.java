...
import com.pulumi.ovh.IpLoadBalancingTcpFarmArgs;
import com.pulumi.ovh.Utilities;
import com.pulumi.ovh.inputs.IpLoadBalancingTcpFarmState;
import com.pulumi.ovh.outputs.IpLoadBalancingTcpFarmProbe;
 ...
 * 
 */
@ResourceType(type="ovh:index/ipLoadBalancingTcpFarm:IpLoadBalancingTcpFarm")
public class IpLoadBalancingTcpFarm extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="probe", type=IpLoadBalancingTcpFarmProbe.class, parameters={})
    private Output</* @Nullable */ IpLoadBalancingTcpFarmProbe> probe;

    /**
     * @return define a backend healthcheck probe
     * 
     */
    public Output<Optional<IpLoadBalancingTcpFarmProbe>> probe() {
     ...
     */
    public IpLoadBalancingTcpFarm(String name) {
        this(name, IpLoadBalancingTcpFarmArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IpLoadBalancingTcpFarm(String name, IpLoadBalancingTcpFarmArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IpLoadBalancingTcpFarm(String name, IpLoadBalancingTcpFarmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFarm:IpLoadBalancingTcpFarm", name, args == null ? IpLoadBalancingTcpFarmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpLoadBalancingTcpFarm(String name, Output<String> id, @Nullable IpLoadBalancingTcpFarmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFarm:IpLoadBalancingTcpFarm", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static IpLoadBalancingTcpFarm get(String name, Output<String> id, @Nullable IpLoadBalancingTcpFarmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
