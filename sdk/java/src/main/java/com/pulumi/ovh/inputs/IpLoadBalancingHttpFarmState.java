...
import com.pulumi.ovh.inputs.IpLoadBalancingHttpFarmProbeArgs;
...
public final class IpLoadBalancingHttpFarmState extends com.pulumi.resources.ResourceArgs {

    public static final IpLoadBalancingHttpFarmState Empty = new IpLoadBalancingHttpFarmState();
     ...
     */
    @Import(name="probe")
    private @Nullable Output<IpLoadBalancingHttpFarmProbeArgs> probe;

    /**
     * @return define a backend healthcheck probe
     * 
     */
    public Optional<Output<IpLoadBalancingHttpFarmProbeArgs>> probe() {
    ...
    private IpLoadBalancingHttpFarmState() {}

    private IpLoadBalancingHttpFarmState(IpLoadBalancingHttpFarmState $) {
    ...
    public static Builder builder(IpLoadBalancingHttpFarmState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpLoadBalancingHttpFarmState();
        }

        public Builder(IpLoadBalancingHttpFarmState defaults) {
            $ = new IpLoadBalancingHttpFarmState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder probe(@Nullable Output<IpLoadBalancingHttpFarmProbeArgs> probe) {
            $.probe = probe;
            return this;
        }
         ...
         * 
         */
        public Builder probe(IpLoadBalancingHttpFarmProbeArgs probe) {
        ...
        public IpLoadBalancingHttpFarmState build() {
            return $;
        }
    }
