...
public final class GetMePaymentmeanBankAccountPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMePaymentmeanBankAccountPlainArgs Empty = new GetMePaymentmeanBankAccountPlainArgs();
    ...
    private GetMePaymentmeanBankAccountPlainArgs() {}

    private GetMePaymentmeanBankAccountPlainArgs(GetMePaymentmeanBankAccountPlainArgs $) {
    ...
    public static Builder builder(GetMePaymentmeanBankAccountPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMePaymentmeanBankAccountPlainArgs();
        }

        public Builder(GetMePaymentmeanBankAccountPlainArgs defaults) {
            $ = new GetMePaymentmeanBankAccountPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMePaymentmeanBankAccountPlainArgs build() {
            return $;
        }
    }
