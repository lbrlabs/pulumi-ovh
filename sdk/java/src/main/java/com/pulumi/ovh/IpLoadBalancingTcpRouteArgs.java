...
public final class IpLoadBalancingTcpRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpLoadBalancingTcpRouteArgs Empty = new IpLoadBalancingTcpRouteArgs();
    ...
    private Output<IpLoadBalancingTcpRouteActionArgs> action;

    /**
     * @return Action triggered when all rules match
     * 
     */
    public Output<IpLoadBalancingTcpRouteActionArgs> action() {
        return this.action;
    }
    ...
    private IpLoadBalancingTcpRouteArgs() {}

    private IpLoadBalancingTcpRouteArgs(IpLoadBalancingTcpRouteArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(IpLoadBalancingTcpRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpLoadBalancingTcpRouteArgs();
        }

        public Builder(IpLoadBalancingTcpRouteArgs defaults) {
            $ = new IpLoadBalancingTcpRouteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder action(Output<IpLoadBalancingTcpRouteActionArgs> action) {
            $.action = action;
            return this;
        }
        ...
        public IpLoadBalancingTcpRouteArgs build() {
