...
@CustomType
public final class CloudProjectKubeNodePoolTemplateMetadata {
    ...
    public static Builder builder(CloudProjectKubeNodePoolTemplateMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> labels;
        public Builder() {}
        public Builder(CloudProjectKubeNodePoolTemplateMetadata defaults) {
        ...
        public CloudProjectKubeNodePoolTemplateMetadata build() {
            final var o = new CloudProjectKubeNodePoolTemplateMetadata();
