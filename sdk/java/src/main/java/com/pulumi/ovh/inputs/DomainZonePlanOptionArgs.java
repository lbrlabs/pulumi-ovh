...
import com.pulumi.ovh.inputs.DomainZonePlanOptionConfigurationArgs;
...
public final class DomainZonePlanOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainZonePlanOptionArgs Empty = new DomainZonePlanOptionArgs();
    ...
    private @Nullable Output<List<DomainZonePlanOptionConfigurationArgs>> configurations;

    /**
     * @return Representation of a configuration item for personalizing product
     * 
     */
    public Optional<Output<List<DomainZonePlanOptionConfigurationArgs>>> configurations() {
    ...
    private DomainZonePlanOptionArgs() {}

    private DomainZonePlanOptionArgs(DomainZonePlanOptionArgs $) {
    ...
    public static Builder builder(DomainZonePlanOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainZonePlanOptionArgs();
        }

        public Builder(DomainZonePlanOptionArgs defaults) {
            $ = new DomainZonePlanOptionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<DomainZonePlanOptionConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<DomainZonePlanOptionConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(DomainZonePlanOptionConfigurationArgs... configurations) {
        ...
        public DomainZonePlanOptionArgs build() {
