...
import com.pulumi.ovh.IpLoadBalancingTcpFarmServerArgs;
import com.pulumi.ovh.Utilities;
import com.pulumi.ovh.inputs.IpLoadBalancingTcpFarmServerState;
 ...
 * 
 */
@ResourceType(type="ovh:index/ipLoadBalancingTcpFarmServer:IpLoadBalancingTcpFarmServer")
public class IpLoadBalancingTcpFarmServer extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public IpLoadBalancingTcpFarmServer(String name) {
        this(name, IpLoadBalancingTcpFarmServerArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IpLoadBalancingTcpFarmServer(String name, IpLoadBalancingTcpFarmServerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IpLoadBalancingTcpFarmServer(String name, IpLoadBalancingTcpFarmServerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFarmServer:IpLoadBalancingTcpFarmServer", name, args == null ? IpLoadBalancingTcpFarmServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpLoadBalancingTcpFarmServer(String name, Output<String> id, @Nullable IpLoadBalancingTcpFarmServerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFarmServer:IpLoadBalancingTcpFarmServer", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static IpLoadBalancingTcpFarmServer get(String name, Output<String> id, @Nullable IpLoadBalancingTcpFarmServerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
