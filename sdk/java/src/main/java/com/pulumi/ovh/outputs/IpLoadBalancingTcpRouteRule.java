...
@CustomType
public final class IpLoadBalancingTcpRouteRule {
    /**
    ...
    public static Builder builder(IpLoadBalancingTcpRouteRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subField;
        public Builder() {}
        public Builder(IpLoadBalancingTcpRouteRule defaults) {
        ...
        public IpLoadBalancingTcpRouteRule build() {
            final var o = new IpLoadBalancingTcpRouteRule();
            o.field = field;
            o.match = match;
            o.negate = negate;
            o.pattern = pattern;
