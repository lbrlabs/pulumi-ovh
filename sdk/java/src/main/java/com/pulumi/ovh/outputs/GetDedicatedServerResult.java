...
import com.pulumi.ovh.outputs.GetDedicatedServerVni;
...
@CustomType
public final class GetDedicatedServerResult {
    /**
     ...
     * 
     */
    private List<GetDedicatedServerVni> vnis;
     ...
     * 
     */
    public List<GetDedicatedServerVni> vnis() {
        return this.vnis;
    }
    ...
    public static Builder builder(GetDedicatedServerResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetDedicatedServerVni> vnis;
        public Builder() {}
        public Builder(GetDedicatedServerResult defaults) {
        ...
        @CustomType.Setter
        public Builder vnis(List<GetDedicatedServerVni> vnis) {
            this.vnis = Objects.requireNonNull(vnis);
            return this;
        }
        public Builder vnis(GetDedicatedServerVni... vnis) {
            return vnis(List.of(vnis));
        }
        public GetDedicatedServerResult build() {
            final var o = new GetDedicatedServerResult();
            o.bootId = bootId;
