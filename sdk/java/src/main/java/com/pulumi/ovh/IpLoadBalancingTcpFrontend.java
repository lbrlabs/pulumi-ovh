...
import com.pulumi.ovh.IpLoadBalancingTcpFrontendArgs;
import com.pulumi.ovh.Utilities;
import com.pulumi.ovh.inputs.IpLoadBalancingTcpFrontendState;
 ...
 * 
 */
@ResourceType(type="ovh:index/ipLoadBalancingTcpFrontend:IpLoadBalancingTcpFrontend")
public class IpLoadBalancingTcpFrontend extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public IpLoadBalancingTcpFrontend(String name) {
        this(name, IpLoadBalancingTcpFrontendArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IpLoadBalancingTcpFrontend(String name, IpLoadBalancingTcpFrontendArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IpLoadBalancingTcpFrontend(String name, IpLoadBalancingTcpFrontendArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFrontend:IpLoadBalancingTcpFrontend", name, args == null ? IpLoadBalancingTcpFrontendArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpLoadBalancingTcpFrontend(String name, Output<String> id, @Nullable IpLoadBalancingTcpFrontendState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/ipLoadBalancingTcpFrontend:IpLoadBalancingTcpFrontend", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static IpLoadBalancingTcpFrontend get(String name, Output<String> id, @Nullable IpLoadBalancingTcpFrontendState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
