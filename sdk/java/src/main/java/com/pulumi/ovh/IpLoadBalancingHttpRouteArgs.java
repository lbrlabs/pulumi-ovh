...
public final class IpLoadBalancingHttpRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpLoadBalancingHttpRouteArgs Empty = new IpLoadBalancingHttpRouteArgs();
    ...
    private Output<IpLoadBalancingHttpRouteActionArgs> action;

    /**
     * @return Action triggered when all rules match
     * 
     */
    public Output<IpLoadBalancingHttpRouteActionArgs> action() {
        return this.action;
    }
    ...
    private IpLoadBalancingHttpRouteArgs() {}

    private IpLoadBalancingHttpRouteArgs(IpLoadBalancingHttpRouteArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(IpLoadBalancingHttpRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpLoadBalancingHttpRouteArgs();
        }

        public Builder(IpLoadBalancingHttpRouteArgs defaults) {
            $ = new IpLoadBalancingHttpRouteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder action(Output<IpLoadBalancingHttpRouteActionArgs> action) {
            $.action = action;
            return this;
        }
        ...
        public IpLoadBalancingHttpRouteArgs build() {
