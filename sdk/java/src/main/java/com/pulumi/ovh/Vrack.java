...
import com.pulumi.ovh.inputs.VrackState;
import com.pulumi.ovh.outputs.VrackOrder;
import com.pulumi.ovh.outputs.VrackPlan;
import com.pulumi.ovh.outputs.VrackPlanOption;
 ...
 * 
 */
@ResourceType(type="ovh:index/vrack:Vrack")
public class Vrack extends com.pulumi.resources.CustomResource {
    ...
    public Vrack(String name, VrackArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/vrack:Vrack", name, args == null ? VrackArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Vrack(String name, Output<String> id, @Nullable VrackState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:index/vrack:Vrack", name, state, makeResourceOptions(options, id));
    }
