...
__all__ = [
    ...
    'get_cloud_project_kube_ip_node_pool',
    'get_cloud_project_kube_ip_node_pool_output',
]

@pulumi.output_type
class GetCloudProjectKubeIpNodePoolResult:
    """
...
class AwaitableGetCloudProjectKubeIpNodePoolResult(GetCloudProjectKubeIpNodePoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudProjectKubeIpNodePoolResult(
...
def get_cloud_project_kube_ip_node_pool(kube_id: Optional[str] = None,
                                        max_nodes: Optional[int] = None,
                                        min_nodes: Optional[int] = None,
                                        name: Optional[str] = None,
                                        service_name: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudProjectKubeIpNodePoolResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getCloudProjectKubeIpNodePool:getCloudProjectKubeIpNodePool', __args__, opts=opts, typ=GetCloudProjectKubeIpNodePoolResult).value

    return AwaitableGetCloudProjectKubeIpNodePoolResult(
...
@_utilities.lift_output_func(get_cloud_project_kube_ip_node_pool)
def get_cloud_project_kube_ip_node_pool_output(kube_id: Optional[pulumi.Input[str]] = None,
                                               max_nodes: Optional[pulumi.Input[Optional[int]]] = None,
                                               min_nodes: Optional[pulumi.Input[Optional[int]]] = None,
                                               name: Optional[pulumi.Input[str]] = None,
                                               service_name: Optional[pulumi.Input[str]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudProjectKubeIpNodePoolResult]:
    """
    Use this data source to get a OVH Managed Kubernetes node pool.
