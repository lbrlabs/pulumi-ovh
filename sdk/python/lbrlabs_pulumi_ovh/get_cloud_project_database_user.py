...
__all__ = [
    ...
    'AwaitableGetCloudProjectDatabaseUserResult',
    'get_cloud_project_database_user',
    'get_cloud_project_database_user_output',
]

@pulumi.output_type
class GetCloudProjectDatabaseUserResult:
    """
...
class AwaitableGetCloudProjectDatabaseUserResult(GetCloudProjectDatabaseUserResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudProjectDatabaseUserResult(
...
def get_cloud_project_database_user(cluster_id: Optional[str] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudProjectDatabaseUserResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getCloudProjectDatabaseUser:getCloudProjectDatabaseUser', __args__, opts=opts, typ=GetCloudProjectDatabaseUserResult).value

    return AwaitableGetCloudProjectDatabaseUserResult(
...
@_utilities.lift_output_func(get_cloud_project_database_user)
def get_cloud_project_database_user_output(cluster_id: Optional[pulumi.Input[str]] = None,
                                           engine: Optional[pulumi.Input[str]] = None,
                                           name: Optional[pulumi.Input[str]] = None,
                                           service_name: Optional[pulumi.Input[str]] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudProjectDatabaseUserResult]:
    """
    Use this data source to get information about a user of a database cluster associated with a public cloud project.
