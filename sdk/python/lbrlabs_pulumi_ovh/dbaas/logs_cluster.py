...
class _LogsClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] archive_allowed_networks: List of IP blocks
        :param pulumi.Input[str] cluster_type: is type of cluster (DEDICATED, PRO or TRIAL)
        :param pulumi.Input[str] dedicated_input_pem: is PEM for dedicated inputs
        :param pulumi.Input[Sequence[pulumi.Input[str]]] direct_input_allowed_networks: List of IP blocks
        :param pulumi.Input[str] direct_input_pem: is PEM for direct inputs
        :param pulumi.Input[str] hostname: is cluster hostname hosting the tenant
        ...
        :param pulumi.Input[bool] is_default: is true if all content generated by given service will be placed on this cluster
        :param pulumi.Input[bool] is_unlocked: is true if given service can perform advanced operations on cluster
        :param pulumi.Input[Sequence[pulumi.Input[str]]] query_allowed_networks: List of IP blocks
        :param pulumi.Input[str] region: is datacenter localization
        """
        if archive_allowed_networks is not None:
            pulumi.set(__self__, "archive_allowed_networks", archive_allowed_networks)
