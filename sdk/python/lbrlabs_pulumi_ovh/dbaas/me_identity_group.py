...
__all__ = ['MeIdentityGroupArgs', 'MeIdentityGroup']

@pulumi.input_type
class MeIdentityGroupArgs:
...
class MeIdentityGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        my_group = ovh.dbaas.MeIdentityGroup("myGroup",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MeIdentityGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates an identity group.
        ...
        :param str resource_name: The name of the resource.
        :param MeIdentityGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MeIdentityGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MeIdentityGroupArgs.__new__(MeIdentityGroupArgs)
        ...
        super(MeIdentityGroup, __self__).__init__(
            'ovh:Dbaas/meIdentityGroup:MeIdentityGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None,
            urn: Optional[pulumi.Input[str]] = None) -> 'MeIdentityGroup':
        """
        ...
        __props__ = _MeIdentityGroupState.__new__(_MeIdentityGroupState)
        ...
        return MeIdentityGroup(resource_name, opts=opts, __props__=__props__)
