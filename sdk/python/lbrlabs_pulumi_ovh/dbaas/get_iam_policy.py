...
def get_iam_policy(allows: Optional[Sequence[str]] = None,
    ...
    my_policy = ovh.Dbaas.get_iam_policy(id="my_policy_id")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('ovh:Dbaas/getIamPolicy:getIamPolicy', __args__, opts=opts, typ=GetIamPolicyResult).value
...
def get_iam_policy_output(allows: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
