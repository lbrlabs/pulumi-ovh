...
__all__ = [
    ...
    'AwaitableGetCloudProjectDatabasesResult',
    'get_cloud_project_databases',
    'get_cloud_project_databases_output',
]

@pulumi.output_type
class GetCloudProjectDatabasesResult:
    """
...
class AwaitableGetCloudProjectDatabasesResult(GetCloudProjectDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudProjectDatabasesResult(
...
def get_cloud_project_databases(engine: Optional[str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudProjectDatabasesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getCloudProjectDatabases:getCloudProjectDatabases', __args__, opts=opts, typ=GetCloudProjectDatabasesResult).value

    return AwaitableGetCloudProjectDatabasesResult(
...
@_utilities.lift_output_func(get_cloud_project_databases)
def get_cloud_project_databases_output(engine: Optional[pulumi.Input[str]] = None,
                                       service_name: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudProjectDatabasesResult]:
    """
    Use this data source to get the list of managed databases of a public cloud project.
