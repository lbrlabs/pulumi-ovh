...
__all__ = ['DedicatedServiceInstallTaskArgs', 'DedicatedServiceInstallTask']

@pulumi.input_type
class DedicatedServiceInstallTaskArgs:
    def __init__(__self__, *,
                 service_name: pulumi.Input[str],
                 template_name: pulumi.Input[str],
                 bootid_on_destroy: Optional[pulumi.Input[int]] = None,
                 details: Optional[pulumi.Input['DedicatedServiceInstallTaskDetailsArgs']] = None,
        ...
        :param pulumi.Input['DedicatedServiceInstallTaskDetailsArgs'] details: see `details` block below.
    ...
    @property
    @pulumi.getter
    def details(self) -> Optional[pulumi.Input['DedicatedServiceInstallTaskDetailsArgs']]:
        """
    ...
    @details.setter
    def details(self, value: Optional[pulumi.Input['DedicatedServiceInstallTaskDetailsArgs']]):
...
@pulumi.input_type
class _DedicatedServiceInstallTaskState:
    def __init__(__self__, *,
                 bootid_on_destroy: Optional[pulumi.Input[int]] = None,
...
class DedicatedServiceInstallTask(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 bootid_on_destroy: Optional[pulumi.Input[int]] = None,
                 details: Optional[pulumi.Input[pulumi.InputType['DedicatedServiceInstallTaskDetailsArgs']]] = None,
                 partition_scheme_name: Optional[pulumi.Input[str]] = None,
                 service_name: Optional[pulumi.Input[str]] = None,
                 template_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DedicatedServiceInstallTask resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[int] bootid_on_destroy: If set, reboot the server on the specified boot id during destroy phase.
        :param pulumi.Input[pulumi.InputType['DedicatedServiceInstallTaskDetailsArgs']] details: see `details` block below.
        :param pulumi.Input[str] partition_scheme_name: Partition scheme name.
        :param pulumi.Input[str] service_name: The service_name of your dedicated server.
        :param pulumi.Input[str] template_name: Template name.
        """
    ...
    def __init__(__self__,
        ...
        Create a DedicatedServiceInstallTask resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DedicatedServiceInstallTaskArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DedicatedServiceInstallTaskArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DedicatedServiceInstallTaskArgs.__new__(DedicatedServiceInstallTaskArgs)
        ...
        super(DedicatedServiceInstallTask, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            template_name: Optional[pulumi.Input[str]] = None) -> 'DedicatedServiceInstallTask':
        """
        ...
        __props__ = _DedicatedServiceInstallTaskState.__new__(_DedicatedServiceInstallTaskState)
        ...
        __props__.__dict__["template_name"] = template_name
        return DedicatedServiceInstallTask(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def details(self) -> pulumi.Output[Optional['outputs.DedicatedServiceInstallTaskDetails']]:
        """
        see `details` block below.
        """
        return pulumi.get(self, "details")
